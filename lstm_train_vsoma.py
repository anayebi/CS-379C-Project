...
#model.load_weights('lstm_my_weights_iter_n') #uncomment if you want to load weights from a previous iteration

#trains the LSTM for 255 epochs, change nb_epoch to something else if you want to train for less epochs, and
...
model.fit(X_train, y_train, batch_size=15, nb_epoch=255, verbose=1, validation_split=0.3)
model.save_weights("lstm_my_weights_iter255") #saves the weights after training to be used for generation